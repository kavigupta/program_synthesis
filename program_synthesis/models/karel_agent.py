...
class KarelEditEnv(object):
    ...
    def __init__(self):
        self.dataset = dataset.KarelTorchDataset(
            dataset.relpath('../data/karel/{}{}.pkl'.format('train', '')), lambda x: x)
...
class KarelEditPolicy(nn.Module):
    def __init__(self, vocab_size, args):
        ...
        self.io_encoder = karel.LGRLTaskEncoder(args)
        self.code_encoder = karel.CodeEncoder(vocab_size, args)

        # Action decoder.
        self.action_type = nn.Linear(100, 5)
        self.action_pointer = attention.SimpleSDPAttention(100,100)#karel_edit.ScaledDotProductPointer(100, 100)
